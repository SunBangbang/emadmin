...
<%//生成工作日
	String result[];
		...
		if( !request.getMethod().equalsIgnoreCase("post") && !Serve.checkMkQx( request ) )
		{
         ...
         {  
			   RSService.createWorkDay( request );        
...
<body >
		  ...
		  <tr>
			...
			<!-- 内容区 -->
				...
				<form name="form1" action="rs_kq_create_gzr.jsp" method="post">
					<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
					  <tr>
						<td align="left"><br/>选择生成的日期范围：<input name=date1  type=text  regName =开始日期 reg=_r_date_ value=><a href='#' onclick='doSelectCalendar("date1")'>选择</a>&nbsp;至&nbsp;<input name=date2  type=text  regName =结束日期 reg=_r_date_ value=><a href='#' onclick='doSelectCalendar("date2")'>选择</a>
