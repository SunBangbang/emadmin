...
<body >
		  ...
		  <tr>
			...
			<!-- 内容区 -->
				...
				<form name="form1" action="rs_gz_count.jsp" method="post">
					<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
					  <tr>
						<td align="left"><br/>选择工资的年度月份：
						<select name='nd'>
						...
						说明：该操作将自动根据公式计算某些工资项目。</br></br>
						<font color='#ff0000'>警告：该操作将自动清除相关项目的工资数据，并且不可恢复！</font>
