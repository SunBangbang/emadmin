...
<body >
		  ...
		  <tr>
			...
			<!-- 内容区 -->
				...
				<form name="form1" action="xs_tc_count.jsp" method="post">
					<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
					  <tr>
						...
						</select> 月 &nbsp; &nbsp;部门：<select name="bm">
							  <%=Api.getQxBmOptionScript(request)%>
							  </select></br></br> 
						</br></br>
						<font color='#ff0000'>警告：该操作将自动清除该月份已存在的数据，并且不可恢复，请务必慎重！</font>
