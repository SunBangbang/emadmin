...
<%
	...
	String isstandardlist = request.getParameter( "isstandardlist" );
		 ...
		 {
			     String rs[]=Api.sb("select khjc from kh_da where   '"+ ids +"' like '%,'+ id +',%'");
...
<!--
       function _doSelect_mainarea_ywy_mc() {  
                 ...
                 var  idValue=''; 
                 result=window.open('/emadmin/shared/popwindow.jsp?bringinitems=bm_mc,yh_mc,bm_id,yh_id,id&popid=win_yh_detail&modul_id=kh_da_yjp_Modul&keywords=' + idValue, mySubDialog,"resizable:Yes;status:no;dialogHeight:500px;dialogWidth:700px;"); 
                 if (result!=true) { 
                           return; 
                 } else { 
	 ...
	 <table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  <tr>
			...
			<!-- 内容区 -->
							...
							<form name="form1" action="kh_yj.jsp" method="get">
...
<table   id="bill_main_table" border="1" cellpadding="0" cellspacing="0" borderColorLight=#B3C3D0 borderColorDark=#ffffff align="center" width="98%">
   ...
   <tr> 
     <td  class="bill_td_10" width="20%" align="right">接收人:</td> 
