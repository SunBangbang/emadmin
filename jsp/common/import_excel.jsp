...
<%@page import="com.lf.lfbase.common.*,java.sql.*,com.lf.lfbase.service.*,java.io.*,java.util.*,org.apache.commons.fileupload.*,org.apache.poi.hssf.usermodel.*,org.apache.poi.poifs.filesystem.* "%>
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 内容区 -->
					<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
						  <form action="import_excel.jsp" method="post" name="form1" enctype="multipart/form-data">
						  <tr>
							<td align="left">	
