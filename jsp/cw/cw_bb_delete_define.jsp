...
<%
	String result[];
		if( !Serve.checkMkQx( request ) )
		{
         ...
         {  
			CWService.deleteBB( request );        

			 response.sendRedirect("/emadmin/shared/message.jsp?message="+URLEncoder.encode("该报表已经成功删除 ！","UTF-8"));
			 return ;
         }
...
<body >
		  ...
		  <tr>
			...
			<!-- 内容区 -->
				...
				<form name="form1" action="cw_bb_delete_define.jsp" method="post" onSubmit="return doCheck(this)">
