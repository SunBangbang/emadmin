...
<%
	String result[];
		if( !Serve.checkMkQx( request ) )
		{
         ...
         {  
			CWService.createBB( request );        

			 response.sendRedirect("/emadmin/shared/message.jsp?message="+URLEncoder.encode("该报表已经成功创建 ！","UTF-8"));
			 return ;
         }
...
<body >
		  ...
		  <tr>
			...
			<!-- 内容区 -->
				...
				<form name="form1" action="cw_bb_create_define.jsp" method="post" onSubmit="return doCheck(this)">
					<table width="90%"  border="0" cellspacing="0" cellpadding="0" align="center">
						<tr >
						<td class="tabletitle">&nbsp;&nbsp;<font color="#ff0000">警告！</font><br>
							&nbsp;&nbsp;如果这个报表已经存在，该操作将全部删除以前的报表数据。<br>
							&nbsp;&nbsp;你确定继续吗？<br><br>
						</td>
						</tr>
					  <tr>
