...
<%
    ...
    try {
        ForumService.addCategory(request);
					...
					<td><table width="100%" border="0" cellspacing="0" cellpadding="5">
					  <tr>
						<td width="100%" height="24"><div align="center">
							<% if (message.length()==0) {%>
						  您已经在<strong>[<%=category==null||category.length==0?"":category[3]%>]</strong>下成功添加了一个名为<strong>[<%=request.getParameter("name")%>]</strong>的栏目！<br>
						  <%}else {%>
						  <%=message%>
