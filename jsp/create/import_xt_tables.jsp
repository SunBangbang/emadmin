...
<%@page import="java.sql.*,com.lf.lfbase.service.*,java.io.*,java.util.*,org.apache.commons.fileupload.*,org.apache.poi.hssf.usermodel.*,org.apache.poi.poifs.filesystem.*,java.net.*,com.lf.util.*,java.util.*"%>
					    ...
					    <div align="center">   
                                <table cellspacing="0" class="x_list_export_result_table"> 
   		                                <tr>
                                            ...
                                            <br/>
                                                    <form name='form1' action="import_xt_tables_add.jsp" method="post" enctype="multipart/form-data">
                                                            <div id='insert_title' class="x_excel_area_title_div">
                                                                    ...
                                                                    <input type="hidden" name="import_type" value="insert"> 
                                                                     ...
                                                                     <img src="/emadmin/images/c2/button/excel_insert.gif" onclick="javascript:insert_content.style.display='block';"  onMouseOver="this.style.cursor='hand'" style="vertical-align:middle"/>
                                                                   <span class="x_excel_alert_message">（提示: 通过Excel导入,批量向数据库中新增数据)</span>
                                                                    
                                                             </div>
                                                            <div id='insert_content' class="x_excel_area_content_div">
                                                                        <div class="x_excel_content_line_div" >第一步：下载右边的Excel模板。&nbsp;&nbsp;&nbsp;&nbsp; <a href="/emadmin/resource/template/表定义.xls" target="_blank" class="x_list_result_title_link"><img src="/emadmin/images/c2/icon/excel.gif" border="0" style="vertical-align:middle"/> 表定义模版</a></div>
