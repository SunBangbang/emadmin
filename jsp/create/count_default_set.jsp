...
<%
	   ...
	   String id = request.getParameter("id");
		...
		String res[] = Api.sb("select count_title from xt_count where id = '"+id+"'");
		String title = "";
		if (res.length>0)	
		{
			title = res[0];
		...
		if( !Serve.checkMkQx( request ) )
		{
         ...
         {
             Serve.saveCountDefaultItems( request );
...
<form name="form1" method="post" action="count_default_set.jsp"   onSubmit="return formBmQxsubmit()">
...
<table  width="100%"   border="1" cellpadding="0" cellspacing="0" borderColorLight=#B3C3D0 borderColorDark=#ffffff>
	<tr  align="center" >
			<td  align="center" class="tabletitle" colspan="5"> 统计默认设置创建  </td>
    </tr>
    <tr >
    <td class="tabletitle"> 统计名称：<%=title%> --<%=id%>     </td>
    </tr>


  <tr>
    <td>	
       <%=Serve.getCountDefaultItems( request )%>
    </td>
  </tr>
