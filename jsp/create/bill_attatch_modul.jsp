...
<%
	...
	String result = "";
		if( !Serve.checkMkQx( request ) )
		{
         ...
         {
			 //执行
			 Serve.modulAttatchBillExec( request );
			 ...
			 result =Serve.getModulAttatchBill( request ); 
...
<body>
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  <tr>
			...
			<!-- 按扭区 --> 
			<!-- 内容区 -->
			<form name="form1" method="post" action="bill_attatch_modul.jsp"  onSubmit="return doCheck(form1)">
