...
<%
    ...
    response.setHeader("Content-Disposition","attachment; filename="+ java.net.URLEncoder.encode("客户池联系人档案", "UTF-8")+".xls");
%>
...
<%
		     ...
		     * 
		     * */
		   sql="select gsmc,xm,xb,szbm,zw,fzyw,gzdh,yddh,jtdh,jtzz,cz,yx,msn,sr,ah,bz from kh_khc_lxr order by gsmc";
