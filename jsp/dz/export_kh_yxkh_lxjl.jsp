...
<%
    ...
    response.setHeader("Content-Disposition","attachment; filename="+ java.net.URLEncoder.encode("意向客户联系记录档案", "UTF-8")+".xls");
%>
...
<%
		     ...
		     * 
		     * */
		   sql="select yxkh, lxr,zxbj,xclxrq,lxzt,lxnr,gzzt,sfzdgz,lxrq from kh_yxkh_lxjl order by yxkh";
