...
<%
        ...
        //根据id 取出 客户名称
  String khmc[]=Api.sb("select khjc from kh_yxkh where id='"+id+"'");
	     if( request.getMethod().equalsIgnoreCase("post") )
         {
               id=request.getParameter("id");
               modulId=request.getParameter("modul_id");
            
						 Api.ub("exec sp_kh_yxkh_zz '"+id+"' ");
...
<body>
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 内容区 -->
					<form name="form1" method="post" action="kh_yxkh_zz.jsp" >
				...
				<div style="width:80%;margin-left:150px " align=center >
				 <table cellspacing="0" class="x_list_export_result_table"  style="height:100px;"> 
						<tr >
								 ...
								 <td class="x_list_export_result_title_td" style="text-align:left;">你确认将名称为<font color="red"><b><%=khmc[0]%></b></font>的意向客户转为正式客户吗？<br>执行此操作后，该客户将被转移到正式客户档案中。</td>
						</tr>
					  </table>
					</div>

                                  <br/>
                                <div align="center" id="_button_area" style="display:block; padding-top:10px;vertical-align:bottom;width:80%;margin-left:150px ">
