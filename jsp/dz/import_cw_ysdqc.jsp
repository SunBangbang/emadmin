...
<%
	...
	if(rsql!=null&&num1>0 ){
		response.sendRedirect("/emadmin/shared/message.jsp?message="+URLEncoder.encode("本系统已有销售单,不能进行应收单的期初导入","UTF-8")+"");
		return ;
	}
%>
<html>
					    ...
					    <div align="center">   
                                <table cellspacing="0" class="x_list_export_result_table"> 
   		                                <tr>
                                            ...
                                            <br/>
                                                    <form name='form1' action="import_cw_ysdqc_add.jsp" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div id='insert_content' class="x_excel_area_content_div_disp">
                                                                        <div class="x_excel_content_line_div" >第一步：下载右边的Excel模板。&nbsp;&nbsp;&nbsp;&nbsp; <a href="/emadmin/resource/template/应收单期初导入模版.xls" target="_blank" class="x_list_result_title_link"><img src="/emadmin/images/c2/icon/excel.gif" border="0" style="vertical-align:middle"/> 应收单期初数据模板</a></div>
