...
<%
	...
	String isstandardlist = request.getParameter( "isstandardlist" );
         ...
         { 
			 ...
			 String rs[]=Api.sb("select yddh from kh_all_lxr where   '"+ ids +"' like '%,'+ id +',%'");
			 String khStr="";
			 ...
			 response.sendRedirect("/emadmin/jsp/dz/kh_dxqf_add.jsp?modul_id=kh_dxqf_addModul&khStr="+URLEncoder.encode(khStr,"UTF-8"));
			 return; 
         }
		 else 
...
<body>
			...
			<!-- 内容区 -->
							...
							<form name="form1" action="kh_dxqf.jsp" method="get">
								<%=result[0]%>
								<%=result[1]%>	
