...
<%
    ...
    response.setHeader("Content-Disposition","attachment; filename="+ java.net.URLEncoder.encode("正式客户联系人档案", "UTF-8")+".xls");
%>
...
<%
		     ...
		     * 
		     * */
		   sql="select khmc,xm,xb,szbm,zw,fzyw,gzdh,yddh,jtdh,jtzz,cz,email,msn,sr,aihao,bz from kh_da_lxr order by khmc";
