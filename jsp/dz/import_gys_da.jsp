					    ...
					    <div align="center">   
                                <table cellspacing="0" class="x_list_export_result_table"> 
   		                                <tr>
                                            ...
                                            <br/>
                                                    <form name='form1' action="import_gys_da_add.jsp" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div id='insert_content' class="x_excel_area_content_div">
                                                                        <div class="x_excel_content_line_div" >第一步：下载右边的Excel模板。&nbsp;&nbsp;&nbsp;&nbsp; <a href="/emadmin/resource/template/供应商档案导入模板.xls" target="_blank" class="x_list_result_title_link_excel"> 供应商数据模板</a></div>
                                                    ...
                                                    <form name='form2' action="import_gys_da_add.jsp" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div id='update_content' class="x_excel_area_content_div">
                                                                        <div class="x_excel_content_line_div" >第一步：从数据库中导出数据。&nbsp;&nbsp;&nbsp;&nbsp; <a href="export_gys_da.jsp" target="_blank" class="x_list_result_title_link_excel"> 导出供应商数据</a></div>
