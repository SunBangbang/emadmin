...
<SCRIPT LANGUAGE='JavaScript'>
   ...
   //设置网页打印的页眉页脚为空 
		...
		//发送邮件
		function  readysendmail()
		{
			var sjrs1=document.getElementsByName("khStr")[0].value;
			var sjrs=sjrs1.substring(0,sjrs1.length-1);
			document.getElementsByName("sjr")[0].value=sjrs;
		}
   //-->
</SCRIPT>
<html>
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 内容区 -->
					<table class="x_bill_outer_table" cellspacing="0" align="center">
						  <tr>
							<td align="left">	
						  <form action="kh_yjqf_add.jsp" method="post" name="form1" >
						   <input type="hidden" name="khStr" value="<%=request.getParameter("khStr")%>">
								 <%=result[1]%>
