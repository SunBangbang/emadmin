...
<SCRIPT LANGUAGE='JavaScript'>
   ...
   //设置网页打印的页眉页脚为空 
		...
		//发送短信
		function  readysenddx()
		{
			var sjh1=document.getElementsByName("khStr")[0].value;
			var sjh=sjh1.substring(0,sjh1.length-1);
			document.getElementsByName("sjh")[0].value=sjh;
		}
   //-->
</SCRIPT>
<html>
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 内容区 -->
					<table class="x_bill_outer_table" cellspacing="0" align="center">
						  <tr>
							<td align="left">	
						  <form action="kh_dxqf_add.jsp" method="post" name="form1" >
