...
<%
    ...
    if( request.getMethod().equalsIgnoreCase("post") )   {
			DefineService.detailTemplate(request);
	...
	r=Api.sb("select bill_template,id from xt_bills where id ='"+table_name +"_detailBill'");
	if (r ==null || r.length<1)
	{
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    ...
    <textarea name="template"   regName ="大文本" rows=5 cols = 50 class="text_normal" style="width: 98%">
	    <%=bill_template%>
    </textarea></div>
