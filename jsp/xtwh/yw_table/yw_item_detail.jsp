...
<body >
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 内容区 --> 
					...
					<form name="form1" method="post" action="yw_item_detail.jsp" >
				 ...
				 <tr>
					<td>	
					   <%=Serve.getYwItemDetailTemplate( request )%>
					</td>
				  </tr>
						  ...
						  <tr >
							<td align="left">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" name="cancel" value="返回"  onclick='javascript:history.back(-1);'></div>
