...
<%@page import="com.lf.lfbase.common.*,java.sql.*,com.lf.lfbase.service.*,java.io.*,java.util.*,org.apache.commons.fileupload.*,org.apache.poi.hssf.usermodel.*,org.apache.poi.poifs.filesystem.*,java.net.* "%>
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 内容区 -->
					<table width="90%"  border="0" cellspacing="0" cellpadding="10" align="center">
						  <form action="import_excel_gys1.jsp" method="post" name="form1" enctype="multipart/form-data">
						  <% if (message.length()>0) {%>
							  <tr>
								<td height="30px">
							  ...
							  <tr height="30px">
							  		<td>
										  <div align="left"  style=" line-height:30px;font-size:12px;">
											  &nbsp;&nbsp;&nbsp;&nbsp;重新上传此文件后，依赖《供应商档案信息》的如下文件需要重新上传：</br>
										  </div>								   </td>
							  </tr>
							  <tr height="30px"> 
							  		<td>
