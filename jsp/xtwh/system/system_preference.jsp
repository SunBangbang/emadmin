...
<%
	...
	String is_change_cbjs = request.getParameter("is_jhcb");
	String jscb_value="";
	if 	( is_change_cbjs!=null  && (is_change_cbjs.equals("1") || is_change_cbjs.equals("0"))) {
		  Api.ub("update xt_preference set value='"+is_change_cbjs+"' where id='is_jhcb' ");
	
	}
    String is_jhcb=Api.getXtPreferenceValueByName("is_jhcb");  // 1 为 进货成本计算方式  0 为 计划成本计算方式
	String is_jhcb_title_X="";
	String is_jhcb_title="";
	if(is_jhcb.equals("1")){
			 is_jhcb_title="计划成本";
			 jscb_value="1";
	...
	if (is_jhcb_title.equals("计划成本")){
	
			 is_jhcb_title_X="进货成本";
	
	}else{
	
				  is_jhcb_title_X="计划成本";
	}
...
<body>
		  ...
		  <!-- 内容区 -->
					...
					<table   cellspacing="0" class="x_list_result_table_sxcs" align="center">
						<% if (!_productCode.equals("crmf") && !_productCode.equals("crmfa")  && !_productCode.equals("kcs") && !_productCode.equals("jxcs")  ){%>
						<tr  align="center" >
						...
						<%}
							if (levelType.equals("advance")&&!_productCode.equals("crmfa")&&!_productCode.equals("crma")&&!_productCode.equals("crm") ){
						%>
						<tr  align="center" >
						...
						<tr  align="center" >
								<td  align="right"  class="x_bill_td_10">自动回收客户</td>
								<td  align="center"  class="x_bill_td_11"><input type='checkbox' name='is_auto_254' <%=getChecked(Api.getXtPreferenceValueByName("auto_hs_khc"),"1")%>  value='1'>启用<font color='red'>自动回收客户</font>功能。</td>
						</tr>
						<%}%>
						...
						<tr>
								...
								<td  align="center"  class="x_bill_td_01">
                                   <% if (_productCode.equals("jxc") || _productCode.equals("jxca")) {%>
                                        ...
                                        <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cgdd"),"1")%> name='is_auto_157' value='1'> <font color='red'>采购订单</font>自动审核。<br/>
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cgd"),"1")%> name='is_auto_050' value='1'> <font color='red'>到货单</font>自动审核。<br/>
                                        ...
                                        <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_fkd"),"1")%> name='is_auto_055' value='1'> <font color='red'>付款单</font>自动审核。<br/>
                                         ...
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_xsd"),"1")%> name='is_auto_052' value='1'> <font color='red'>销售发货单</font>自动审核。<br/>
                                        <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_xsfp"),"1")%> name='is_auto_250' value='1'> <font color='red'>销售发票</font>自动审核。<br/>
                                           <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_lsd"),"1")%> name='is_auto_053' value='1'> <font color='red'>零售单</font>自动审核。<br/>
                                         ...
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_zzd"),"1")%> name='is_auto_059' value='1'> <font color='red'>组装单</font>自动审核。<br/>
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cfd"),"1")%> name='is_auto_060' value='1'> <font color='red'>拆分单</font>自动审核。<br/>
                                          <%} %>
                                   ...
                                   <% }%>
                                    <% if (_productCode.equals("crm")|| _productCode.equals("crma") ) {%>
                                     ...
                                     <% if (_productCode.equals("crmf")|| _productCode.equals("crmfa") ) {%>
                                         ...
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_fwht"),"1")%> name='is_auto_160' value='1'> <font color='red'>服务合同</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_fwfp"),"1")%> name='is_auto_161' value='1'> <font color='red'>服务发票</font>自动审核。<br/>
                                           <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_ysd"),"1")%> name='is_auto_253' value='1'> <font color='red'>应收单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_skd"),"1")%> name='is_auto_056' value='1'> <font color='red'>收款单</font>自动审核。<br/>

                                           <%if (_productCode.equals("crmfa")){ %>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_yskd"),"1")%> name='is_auto_151' value='1'> <font color='red'>预收单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_zjzz"),"1")%> name='is_auto_153' value='1'> <font color='red'>账间转账</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_szjl"),"1")%> name='is_auto_154' value='1'> <font color='red'>直接入帐</font>自动审核。<br/>
                                        ...
                                        <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_xsfp"),"1")%> name='is_auto_250' value='1'> <font color='red'>销售发票</font>自动审核。<br/>
										 ...
										 <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_fwht"),"1")%> name='is_auto_160' value='1'> <font color='red'>服务合同</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_fwfp"),"1")%> name='is_auto_161' value='1'> <font color='red'>服务发票</font>自动审核。<br/>
                                           <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_ysd"),"1")%> name='is_auto_253' value='1'> <font color='red'>应收单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_skd"),"1")%> name='is_auto_056' value='1'> <font color='red'>收款单</font>自动审核。<br/>
                                           <% if (!_productCode.equals("em")&&!_productCode.equals("emc")  ) {%>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_yskd"),"1")%> name='is_auto_151' value='1'> <font color='red'>预收单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_yfkd"),"1")%> name='is_auto_150' value='1'> <font color='red'>预付单</font>自动审核。<br/>
                                           <% }%>  
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_rkd"),"1")%> name='is_auto_051' value='1'> <font color='red'>入库单</font>自动审核。<br/>
                                          ...
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_szjl"),"1")%> name='is_auto_154' value='1'> <font color='red'>直接入帐</font>自动审核。<br/>
                                          <% }%>  
										  <%  if (_productCode.equals("emc") || _productCode.equals("erpc") ) {%>
											<input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_sctzd"),"1")%> name='is_auto_162' value='1'> <font color='red'>生产通知单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_lld"),"1")%> name='is_auto_163' value='1'> <font color='red'>领料单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_bld"),"1")%> name='is_auto_164' value='1'> <font color='red'>补料单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_tld"),"1")%> name='is_auto_165' value='1'> <font color='red'>退料单</font>自动审核。<br/>
                                   		  <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_wgdj"),"1")%> name='is_auto_166' value='1'> <font color='red'>完工登记</font>自动审核。<br/>
                                   		  <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_scjh"),"1")%> name='is_auto_167' value='1'> <font color='red'>生产计划</font>自动审核。<br/>
										  <%}%>
                                   <% }%>  
                                   ...
                                   <% }%>  
                                        ...
                                        <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_fkd"),"1")%> name='is_auto_055' value='1'> <font color='red'>付款单</font>自动审核。<br/>                  
                                          ...
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_pdd"),"1")%> name='is_auto_058' value='1'> <font color='red'>盘点单</font>自动审核。<br/>
                                   <% }%>  
                                   <% if (_productCode.equals("kc") || _productCode.equals("kca") || _productCode.equals("sc")) {%>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_rkd"),"1")%> name='is_auto_051' value='1'> <font color='red'>入库单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_ckd"),"1")%> name='is_auto_054' value='1'> <font color='red'>出库单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_dbd"),"1")%> name='is_auto_057' value='1'> <font color='red'>调拨单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_pdd"),"1")%> name='is_auto_058' value='1'> <font color='red'>盘点单</font>自动审核。<br/>
                                          <% if (_productCode.equals("kca") || _productCode.equals("sc")){%>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_zzd"),"1")%> name='is_auto_059' value='1'> <font color='red'>组装单</font>自动审核。<br/>
                                          <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cfd"),"1")%> name='is_auto_060' value='1'> <font color='red'>拆分单</font>自动审核。<br/>
                                          <%} %>
                                          <% if (_productCode.equals("sc")) {%> 
										  <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_qgd"),"1")%> name='is_auto_156' value='1'> <font color='red'>请购单</font>自动审核。<br/>
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cgdd"),"1")%> name='is_auto_157' value='1'> <font color='red'>采购订单</font>自动审核。<br/>
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cgfp"),"1")%> name='is_auto_158' value='1'> <font color='red'>采购发票</font>自动审核。<br/>
                                         <input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("auto_sh_cgd"),"1")%> name='is_auto_050' value='1'> <font color='red'>到货单</font>自动审核。<br/>
						 ...
						 <% if (_productCode.equals("kcs")) {%>
	                            <input type='hidden'  name='is_auto_051' value='1'> 
	                            <input type='hidden'  name='is_auto_054' value='1'> 
                         <% }%>  
						<tr  align="center" >
						...
						<tr  align="center" >
								...
								<td align="center"  class="x_bill_td_01">当前成本计算方式：<font color='red'><%=is_jhcb_title%></font> 要设置成
								<input type='checkbox' <%=getChecked(Api.getXtPreferenceValueByName("is_jhcb"),"8")%> name='is_jhcb' value='<%=jscb_value.equals("0")?"1":"0"%>'><%=is_jhcb_title_X%>
                                </td>
						</tr>	
						-->
						<tr ><input type="hidden" name="is_kc_yj" value="1">
