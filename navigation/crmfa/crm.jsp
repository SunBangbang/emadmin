...
<area shape="rect" coords="527,6,618,95" href="<%=Serve.getModulUrlStr(request,"fw_ht_listModul")%>">
<%}%>
<% if (Serve.getModulUrlStr(request,"kh_yxkh_lxjl_listModul").length()>0) {%>
<area shape="rect" coords="11,128,182,217" href="<%=Serve.getModulUrlStr(request,"kh_yxkh_lxjl_listModul")%>">
<%}%>
<% if (Serve.getModulUrlStr(request,"kh_da_lxjl_listModul").length()>0) {%>
<area shape="rect" coords="239,128,420,220" href="<%=Serve.getModulUrlStr(request,"kh_da_lxjl_listModul")%>">
<%}%>
...
<area shape="rect" coords="533,126,624,219" href="<%=Serve.getModulUrlStr(request,"fw_ht_gzjl_listModul")%>">
<%}%>

<% if (Serve.getModulUrlStr(request,"kh_da_listModul").length()>0) {%>
<area shape="rect" coords="242,14,419,101" href="<%=Serve.getModulUrlStr(request,"kh_da_listModul")%>">
<%}%>
<% if (Serve.getModulUrlStr(request,"kh_yxkh_listModul").length()>0) {%>
<area shape="rect" coords="9,15,182,103" href="<%=Serve.getModulUrlStr(request,"kh_yxkh_listModul")%>">
<%}%>
